...
if ($validator->passes())
{
$orig_file_name = Input::file('file')->getClientOriginalName();
...
Input::file('file')->move($abs_storage_dir, $new_file_name);
...
$gedcom->save();
return Redirect::to('gedcoms/index')->with('message', 'The file ' . $gedcom->file_name . ' has been uploaded. '
. 'Press <span class="glyphicon glyphicon-save"></span> to parse the file.');
}
else
{
