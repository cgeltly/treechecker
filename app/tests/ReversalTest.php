...
class ReversalTest extends TestCase
{
    ...
    public function testFamily()
    {
        ...
        // F2 has no husband, I4 (Frida /Schmidt/) is the wife, and has a note
        $family = GedcomFamily::GedcomKey($gedcom->id, 'F2')->first();
        $this->assertEmpty($family->husband);
        $this->assertEquals($family->wife->gedcom_key, 'I4');
        $this->assertEquals($family->notes()->count(), 1);
    }
